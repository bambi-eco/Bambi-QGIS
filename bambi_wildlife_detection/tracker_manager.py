...
class TrackerManager:
    ...
    def is_georef_available(self) -> bool:
        ...
        if self._georef_available is None:
            ...
            try:
                ...
                import georef_tracker  # noqa: F401
                self._georef_available = True
    ...
    def get_available_trackers(self) -> Dict[str, TrackerInfo]:
        ...
        trackers["builtin"] = TrackerInfo(
            ...
            description=(
                "Default tracker using Hungarian algorithm with IoU matching."
        ...
        for key, value in params.items():
            if key in valid_params:
                ...
                try:
                    ...
                    if log_fn:
                        log_fn(
                            f"Warning: Invalid value for parameter '{key}': {value}"
    ...
    def _download_osnet_reid(self, log_fn=None) -> Optional[str]:
        ...
        if log_fn:
            log_fn("Downloading OSNET ReID model from Google Drive...")
    ...
    def _download_bambi_reid(self, log_fn=None) -> Optional[str]:
        ...
        if log_fn:
            log_fn("Downloading BAMBI Thermal-Omni ReID model from HuggingFace...")
            log_fn("This may take a moment...")
        ...
        if log_fn:
            ...
            log_fn("Use 'custom' ReID option with a local file path instead.")
        ...
        if info.requires_reid:
            ...
            if not reid_weights:
                raise RuntimeError(
                    ...
                    "Please ensure you have internet access or provide custom weights."
                )
