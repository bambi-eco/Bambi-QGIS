...
CONFIG_ENTRIES: List[ConfigEntry] = [
    ...
    ConfigEntry("ALFS/FixedRenderSize", "bool", False),
    ConfigEntry("ALFS/RenderWidth", "int_double", 2048),
    ConfigEntry("ALFS/RenderHeight", "int_double", 2048),
    ...
    ConfigEntry("Inventory/Columns", "str"),
    ...
    ConfigEntry("Match/Space", "int_double", 0),
    ConfigEntry("Match/GateMetres", "double", 1.5),
...
WIDGET_BINDINGS: Dict[str, Tuple[str, str]] = {
    ...
    "ALFS/FixedRenderSize": ("alfs_fixed_size_check", "check"),
    "ALFS/RenderWidth": ("alfs_render_width_spin", "spin"),
    "ALFS/RenderHeight": ("alfs_render_height_spin", "spin"),
    ...
    "Inventory/Columns": ("_inventory_columns", "json"),
    "Match/MinSharedFrames": ("match_min_shared_spin", "spin"),
    "Match/GatePx": ("match_gate_spin", "spin"),
    "Match/Space": ("match_space_combo", "combo_index"),
    "Match/GateMetres": ("match_gate_m_spin", "spin"),
